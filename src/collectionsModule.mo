...
module {
                ...
                case (?keysBlob) {
                    ...
                    switch (keys) {
                        case (?keysArray) {
                            ...
                            ignore await EkvmModule.put(ekvm, keysKey, keysArrayBlob, false);
                        };
                        case null {
    ...
    public func get(ekvm : EkvmModule.Ekvm, keyPath : Text, key : Text) : async ?Blob {
        let fullKey = keyPath;
        await EkvmModule.get(ekvm, fullKey);
    };
